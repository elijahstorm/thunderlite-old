var Levels_Class = function()
{
	...
	{	// parses script data into functionable commands
		...
		{	// list of commands with a single event call
			...
			self.Do_Event = function(i)
			{
				...
				{
					if(pointer[actions[i][1][0]][actions[i][1][1]]==null)
						pointer[actions[i][1][0]][actions[i][1][1]] = Core.Point(actions[i][1][0], actions[i][1][1]);
				}
				else if(actions[i][0]=="unhl")
				{
					if(pointer[actions[i][1][0]][actions[i][1][1]]!=null)
					{
						pointer[actions[i][1][0]][actions[i][1][1]][0].Remove(pointer[actions[i][1][0]][actions[i][1][1]][1]);
						pointer[actions[i][1][0]][actions[i][1][1]] = null;
					}
				}
		...
		let pointer = new Array(Game.Terrain_Map.Width);
		for(let __i=0;__i<pointer.length;__i++)
			pointer[__i] = new Array(Game.Terrain_Map.Height);
	...
	let LevelData = {
		...
		Map:[
			...
			"h {s}jm¡ ¡R¡¤lt§lmd^b^b^bld^c^f^blc^b^e^blc^c^j^blg^c^h^blf^b^j^blh^b^k^blce^i^i^clce^j^j^clce^i^h^clce^i^g^clce^k^k^clce^cb^cb^clce^cc^cb^clce^j^f^clce^cb^f^clce^cc^f^clce^k^f^clcd^cb^i^clcc^k^b^clcc^h^c^clcc^j^d^cld^k^d^cld^h^e^cld^cc^c^cld^cb^b^cld^b^d^bld^c^cb^blme^cc^k^cld^cb^j^clmbmn¥¦¤¦p<<¦R~ lRT¡©R¦ R«¡§SST^RTR§```T<¦R¡¤¤lRTY¤R ¡¦R¡§¦R¡R¦R©¡¡¥R«¦ST<¦Ry  ¡ lRT{R¨R©«R¦¡¡R «R§ ¦¥R¡¢¤R¦¡R«¡§^R R¤¥¡§¤¥R¨¥¦SR¥R¥RR¤¦R ^R R{R¨R¦R¦¦¤R¤¡§ `T<<lRcb^Ri<©¦lRc<¦R¡¤¤lRT~ R¦¥R¥¥RR¦¤¡§SRy  ¡ R¥R¡¤R¤¥¡§¤¥R R¡¤R¦¤¡¡¢¥R¥R©`Rs R¦¦R¤R R¥RRR¤ `R{¦R R§R¤ ¡¤ ¦¥R§¥ R¤¡§¤¥¥R¦R¡¦¥R¤¡R¦R¤¡§ `T<§ lRcb^Ri<<lRi^Rd<lRi^Re<lRj^Rh<lRcb^Rc<lRcc^Rb<lRcc^Rd<<©¦lRf<<§ lRi^Rd<§ lRi^Re<§ lRj^Rh<§ lRcb^Rc<§ lRcc^Rb<§ lRcc^Rd<<<¦R¡¤¤lRTR¨R¦¡R§¥R¦¨R¥¦¤¦«R¦¡R¨¡R« R¤`R~¦Y¥R¨R¡§¤R¦¤¡¡¢¥R§RR¦¤ R¡ R¦R¡¥¦R¥¡R¦¦R©R R§ ¤R¡© R R¤¦RR ¥¨R¢¡¥¦¡ `T<<¡¨lRb^bR<©¦lRc<¦¤¤ lRTu «¡ T^Rd^Rb<©¦lRc<¦¤¤ lRTu «¡ T^Rd^Rc<©¦lRc<¦¤¤ lRTu «¡ T^Rd^Rd<©¦lRc<<¦R¡¤¤lRTu «¡ ¥R¢¤¡¨R¡¡R ¥R¦¡R«¡§¤R¦¤¡¡¢¥R R¡ ^R R¥¡R¥¦¡¢R¡ R¤ R©¢¡ ¤«R¤¡R R¦¨R ¥¦R«¡§¤R¦¤¡¡¢¥R R¦R¦¤ ¥`T<¦R¡¤¤lRTt¤¥R R¡¥R¢¤¡¨R¨¤«R¦¦R ¥^R¥¡R¡ ¥¤R¦¥R©R«¡§R §¨¤R«¡§�