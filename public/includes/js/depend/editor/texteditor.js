...
var CanvasTextEditor = function(doc, options) {
  ...
  this._createWrapper(this.options.left, this.options.top);
 ...
 * @private
 */
CanvasTextEditor.prototype._createWrapper = function(left, top) {
...
CanvasTextEditor.prototype.reflow = function(scaleX, scaleY){
 this.wrapper.style.left = (this.options.left*scaleX)+'px';
 this.wrapper.style.top = (this.options.top*scaleY)+'px';
 this.resize(this.options.width*scaleX, this.options.height*scaleY);
};
